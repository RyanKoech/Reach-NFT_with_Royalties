...
export const SeeOutcome = ({price, address }) => { 
  ...
  return (
    <div className="w-full h-screen bg-zinc-100 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 mx-w-[1240px] m-auto">
      <div>
      `{formatAddress} <p className=" font-bold">won the Auction and Paid</p> {formatPrice} <p className=" font-bold">ALGO. Watchout for the next Auction to begin</p>`
      </div>
      </div>
...
export const ShowBid = ({bid}) => {
  ...
  return (
    <div className="w-full h-screen bg-zinc-100 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 mx-w-[1240px] m-auto">
      <div>`<p className=" font-bold">Current leading  bid is</p> {formatBid} <p className=" font-bold">ALGO. Waiting for next bidder...</p>`</div>
      </div>
  ...
  return(
    <div className="w-full h-screen bg-zinc-100 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 mx-w-[1240px] m-auto">
        ...
        <p className="py-3 text-5xl md:text-5xl font-bold">Wanna Start the Bid?</p>
        <button className="py-3 px-6 sm:w-[50%] my-4 flex bg-cyan-700 text-white font-bold rounded-lg " onClick={handleAccept}>Yes</button>
        <button className="py-3 px-6 sm:w-[50%] my-4 flex bg-cyan-700 text-white font-bold rounded-lg " onClick={handleReject}>No</button>
        </div>
